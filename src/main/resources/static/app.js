...
function CallApp({ roomId, autoJoin }) {
    ...
    return React.createElement('div', { className: 'room-shell', onPointerDown: revealControls },
        React.createElement('header', { className: 'room-top' }, React.createElement('a', { className: 'brand', href: '/' }, React.createElement('span', { className: 'brand-mark' }, 't'), ' talkme'), React.createElement('div', { className: 'room-top-actions' }, React.createElement('button', { className: 'pwa-install-button', type: 'button' }, 'Install app'), React.createElement('div', { className: 'room-status' }, React.createElement('span', { className: 'status-dot' }), connected ? 'connected' : 'waiting for someone'))),
